...
(function($) {
    ...
    !function(t) {
        ...
        "use strict";
        if (!C.history.pushState)
            return b.fn.smoothState = function() {
                return this
            }
            ,
        ...
        if (!b.fn.smoothState) {
            var T = b("html, body")
              ...
              , x = {
                ...
                triggerAllAnimationEndEvent: function(e, t) {
                    ...
                    e.on("animationstart webkitAnimationStart oanimationstart MSAnimationStart", function(t) {
                        b(t.delegateTarget).is(e) && (t.stopPropagation(),
                        n++)
                    }),
              ...
              , n = function(t, s) {
                var e, l = b(t), c = l.prop("id"), o = null, r = !1, u = {}, d = {}, n = C.location.href, f = function(t) {
                    (t = t || !1) && u.hasOwnProperty(t) ? delete u[t] : u = {},
                    l.data("smoothState").cache = u
                }, h = function(t, e) {
                    e = e || b.noop;
                    var r = x.translate(t);
                    ...
                    n.length ? (E.title = u[t].title,
                    l.data("smoothState").href = t,
                      ...
                      , e = {
                        loaded: function() {
                            ...
                            n) {
                                ...
                                u[r.url].state = d,
                                C.history.pushState(d, u[r.url].title, e)
                            }
                            i && !o && f(r.url)
                        },
                        fetching: function() {
                    ...
                    x.shouldLoadAnchor(n, s.blacklist, s.hrefRegex) && !r && (t.stopPropagation(),
                    e = x.translate(n.prop("href")),
                    e = s.alterRequest(e),
                    h(e))
                }, g = function(t) {
                    var e = b(t.currentTarget);
                    if (!t.metaKey && !t.ctrlKey && x.shouldLoadAnchor(e, s.blacklist, s.hrefRegex) && (t.stopPropagation(),
                    t.preventDefault(),
                    !y())) {
                        S();
                    ...
                    var e = b(t.currentTarget);
                    if (!e.is(s.blacklist) && (t.preventDefault(),
                    t.stopPropagation(),
                    !y())) {
                        S();
                        var n = {
                ...
                return s = b.extend({}, b.fn.smoothState.options, s),
                null === C.history.state ? (d = s.alterChangeState({
                    id: c
                }, E.title, n),
                C.history.replaceState(d, E.title, n)) : d = {},
                x.storePageIn(u, n, E.documentElement.outerHTML, c, d),
                x.triggerAllAnimationEndEvent(l, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"),
                e = l,
                s.anchors && (e.on("click", s.anchors, g),
                w(e)),
                s.forms && e.on("submit", s.forms, m),
                {
                    href: n,
                    cache: u,
                    clear: f,
            ...
            C.onpopstate = function(t) {
                if (b("body").addClass("back-pressed"),
                setTimeout(function() {
                ...
                null !== t.state) {
                    ...
                    (o || r) && (r && n.clear(n.href),
                    n.load(e, !1))
                }
            }
            ,
            b.smoothStateUtility = x,
            b.fn.smoothState = function(e) {
                return this.each(function() {
    ...
    !function(t, s, e, i) {
        ...
        t.extend(n.prototype, {
            init: function() {
                ...
                this.date = new Date,
                this.current_day = this.weekdays[this.date.getDay()],
                this.current_hour = this.date.getHours(),
                this.current_minute = this.date.getMinutes(),
                this.place_is_open = !1,
                this.hoursForToday = this.settings.openingTimes[this.current_day],
                "object" == typeof this.hoursForToday ? 2 == this.hoursForToday.length && (this.open_unix_time_today = this.timeStringToDate(this.hoursForToday[0]),
                this.close_unix_time_today = this.timeStringToDate(this.hoursForToday[1]),
                this.date <= this.close_unix_time_today && this.date >= this.open_unix_time_today && (this.place_is_open = !0)) : !0 === this.hoursForToday && (this.place_is_open = !0),
                this.place_is_open ? t(this.element).append(this.settings.openString).addClass(this.settings.openClass) : t(this.element).append(this.settings.closedString).addClass(this.settings.closedClass)
            },
    ...
    !function(e) {
        ...
        n.fn.hammer = function(r) {
            return this.each(function() {
                var e, t;
                e = r,
                (t = n(this)).data("hammer") || t.data("hammer", new a(t[0],e))
            })
        }
        ,
        a.Manager.prototype.emit = (r = a.Manager.prototype.emit,
        function(e, t) {
            r.call(this, e, t),
    ...
    !function(t, i) {
        ...
        i.prototype.changeImage = function(i) {
            ...
            a.onload = function() {
                ...
                n.width(a.width),
                n.height(a.height),
                e.options.fitImagesInViewport && (d = t(window).width(),
                l = t(window).height(),
                r = d - e.containerPadding.left - e.containerPadding.right - e.imageBorderWidth.left - e.imageBorderWidth.right - 20,
                h = l - e.containerPadding.top - e.containerPadding.bottom - e.imageBorderWidth.top - e.imageBorderWidth.bottom - 120,
                e.options.maxWidth && e.options.maxWidth < r && (r = e.options.maxWidth),
                e.options.maxHeight && e.options.maxHeight < r && (h = e.options.maxHeight),
                (a.width > r || a.height > h) && (a.width / r > a.height / h ? (s = r,
        ...
        i.prototype.updateDetails = function() {
            if (void 0 !== this.album[this.currentImageIndex].title && "" !== this.album[this.currentImageIndex].title) {
                ...
                i.fadeIn("fast").find("a").on("click", function(i) {
