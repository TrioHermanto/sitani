...
<body class="theme-light" data-highlight="green1">
    ...
    <div id="page">
        ...
        <div class="header header-fixed header-auto-show header-logo-app">
            <a href="<?php echo base_url('admin'); ?>" class="header-title" style="font-size: 18px;">SiTani</a>
            <a href="<?php echo base_url('admin'); ?>" data-back-button class="header-icon header-icon-1"><i class="fas font-18 fa-arrow-left mt-3"></i></a>
        ...
        <div class="page-content">
            ...
            <div class="page-title page-title-small">
                <h2><a href="<?php echo base_url('admin'); ?>" data-back-button><i class="fa fa-arrow-left"></i></a>Profile</h2>
            </div>
            ...
            <div class="card card-style">
                <div class="content mt-0 mb-2">
                    <div class="list-group list-custom-large mb-4">
                        ...
                        <a href="<?php echo base_url('tugas/inputtugas'); ?>">
                            <i class="fa font-14 fa-calendar-days bg-green1-dark rounded-sm"></i>
                            <span>Buat Tugas</span>
                            <strong>buat tugas harian disini.</strong>
                            <i class="fa fa-angle-right mr-2"></i>
                        </a>
                        <a href="<?php echo base_url('pohon/tambahpohon'); ?>">
                            <i class="fa font-14 fa-qrcode bg-green1-dark rounded-sm"></i>
                            <span>Tambah Data Pohon</span>
                            <strong>menambahkan data pohon disini.</strong>
                            <i class="fa fa-angle-right mr-2"></i>
                        </a>
                        <a href="<?php echo base_url('admin/tambahUser'); ?>">
                            <i class="fa font-14 fa-user-plus bg-green1-dark rounded-sm"></i>
                            <span>Tambah User</span>
                            <strong>tambah user untuk mengelola lahan pertanianmu.</strong>
                            <i class="fa fa-angle-right mr-2"></i>
                        </a>
                        <a href="<?php echo base_url('admin/editProfile'); ?>">
