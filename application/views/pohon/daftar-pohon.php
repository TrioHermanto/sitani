...
<body class="theme-light" data-highlight="green1">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-5">
            ...
            <a href="<?php echo base_url('pohon'); ?>" class="active-nav"><i data-feather="file" data-feather-line="1" data-feather-size="21" data-feather-color="brown1-dark" data-feather-bg="brown1-fade-light"></i><span class="mt-1">Pohon</span></a>
        ...
        <div class="page-content">
            ...
            <div class="page-title page-title-small">
                <h2><a href="<?php echo base_url('admin'); ?>" data-back-button><i class="fa fa-arrow-left"></i></a>Daftar Pohon</h2>
