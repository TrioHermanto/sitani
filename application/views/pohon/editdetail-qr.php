        ...
        <div class="page-content">
            ...
            <div class="card card-style">
                <div class="content mb-0">
                    <?php echo form_open_multipart('pohon/updatepohon'); ?>
                    <p>
                    ...
                    <?php foreach ($data as $d) : ?>
                        ...
                        <div class="form-group input-style input-style-2 has-icon input-required">
                            ...
                            <input class="form-control form-control-user" type="text" id="kode" name="kode" placeholder="" value="<?php echo $d->kode ?>" readonly>
                        </div>
                        <div class="form-group input-style input-style-2 has-icon input-required">
                        ...
                        <div class="form-group input-style input-style-2 has-icon input-required">
                            ...
                            <em style="color: black; font-weight:bold">(required)</em>
                            <input class="form-control form-control-user" type="text" id="penanaman" name="penanaman" placeholder="" value="<?php echo $d->tgl_penanaman ?>">
                        </div>
                        <div class="form-group input-style input-style-2 has-icon input-required">
                            <i class="input-icon fa fa-calendar-day"></i>
