...
<body class="theme-light" data-highlight="green1">
    ...
    <div id="page">
        ...
        <div class="page-content">
            ...
            <div class="page-title page-title-small">
                <h2><a href="<?php echo base_url('admin/profile'); ?>" data-back-button><i class="fa fa-arrow-left"></i></a>Tambah Pohon</h2>
            </div>
            ...
            <div class="card card-style">
                <div class="content mb-0">
                    <form class="user" method="post" action="<?php echo base_url('admin/tambahpohon'); ?>">
                        <p>
                            Tambahkan data pohon anda di sini
                        </p>
                        ...
                        <div class="form-group input-style input-style-2 has-icon input-required">
                            ...
                            <span class="color-highlight">Kode Pohon</span>
                            <em style="color: black; font-weight:bold;">(required)</em>
                            <input class="form-control form-control-user" type="text" id="kode" name="kode" placeholder="">
                        </div>
                        <div class="form-group input-style input-style-2 has-icon input-required">
                            <i class="input-icon fa fa-edit"></i>
                        ...
                        <div class="form-group input-style input-style-2 has-icon input-required">
                            ...
                            <em style="color: black; font-weight:bold;">(required)</em>
                            <input class="form-control form-control-user" type="text" id="jenis" name="jenis" placeholder="">
                        </div>
                        <div class="form-group input-style input-style-2 has-icon input-required">
                            <i class="input-icon fa fa-calendar-day"></i>
                            <span class="color-highlight">Tanggal Penanaman</span>
                            <em style="color: black; font-weight:bold;">(required)</em>
                            <input class="form-control form-control-user" type="date" id="penanaman" name="penanaman" placeholder="">
                        </div>
                        <button type="submit" class="btn alert-success mb-3" style="margin-left: 35%;">Simpan</button>
                    </form>
                </div>
            </div>
    ...
    <script>
        function detail(id) {
            // alert(id);
            $.ajax({
                url: "<?php echo base_url('admin/detailpohon') ?>",
                type: 'POST',
                data: {
                    id: id
                },
