...
<body class="theme-light" data-highlight="green1">
    ...
    <div id="page">
        ...
        <div class="header header-fixed header-auto-show header-logo-app">
            <a href="<?php echo base_url('pengelola/profile'); ?>" class="header-title" style="font-size: 18px;">SiTani</a>
            <a href="<?php echo base_url('pengelola/profile'); ?>" data-back-button class="header-icon header-icon-1"><i class="fas font-18 fa-arrow-left mt-3"></i></a>
        ...
        <div id="footer-bar" class="footer-bar-5">
            ...
            <a href="<?php echo base_url('pengelola/profile'); ?>" class="active-nav"><i data-feather="user" data-feather-line="1" data-feather-size="21" data-feather-color="gray2-dark" data-feather-bg="gray2-fade-light"></i><span class="mt-1">User</span></a>
        </div>

        <div class="page-content">

            <div class="page-title page-title-small">
                <h2><a href="<?php echo base_url('pengelola/profile'); ?>" data-back-button><i class="fa fa-arrow-left"></i></a>Edit Profile</h2>
            </div>
            ...
            <div class="card card-style">
                <div class="content mb-0">
                    <?php echo form_open_multipart('pengelola/editProfile'); ?>
                    <h3>Edit Pprofile</h3>
                    <p>
